...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
		  ...
		  // Astolfo
		  LOADED: "Loaded!",
		  GREATER_THAN_ZERO: "Sorry! You cannot use a number less than 1.",
		  IS_BOT: "Sorry! You cannot perform this action on a bot.",
		  IS_SELF: "Sorry! You cannot perform this action on yourself.",
		  IS_ASTOLFO: "Sorry! You cannot peform this action on me.",
		  
		    // Balance
		  LOAD_BALANCE: "Loading balance...",
		  BALANCE_DESC: "This is your balance. It contains data on all the currency you have collected.",
		  CR: "Credits",
		  TC: "Trap Coins",
		  AT: "Apocrypha Tokens",
		  ERR_NO_BALANCE: "Sorry! This user does not have an account and cannot have economy actions performed on them until they run the balance command.",
